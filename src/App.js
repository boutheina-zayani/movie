  ...
  return (
    <div className="App">
      <div className="header"> 
            ...
            <div className="add-header"><AddMovie movie={movie} setMovie={setMovie}/> </div>
    </div>
